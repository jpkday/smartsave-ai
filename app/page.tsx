        ...
        <div className="grid grid-cols-1 gap-4 md:hidden">
          {isLocked ? (
            ...
            <>
              ...
              {/* Secondary Grid */}
              <div className="grid grid-cols-2 gap-4">
                <Link href="/receipts?scan=true&returnTo=/" className="bg-orange-500 text-white p-5 rounded-2xl font-bold shadow-md hover:shadow-lg hover:-translate-y-0.5 transition flex flex-col items-center gap-2 text-center">
                  <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 9a2 2 0 012-2h.93a2 2 0 001.664-.89l.812-1.22A2 2 0 0110.07 4h3.86a2 2 0 011.664.89l.812 1.22A2 2 0 0018.07 7H19a2 2 0 012 2v9a2 2 0 01-2 2H5a2 2 0 01-2-2V9z" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 13a3 3 0 11-6 0 3 3 0 016 0z" /></svg>
        ...
        <div className="hidden md:grid grid-cols-3 gap-8 items-start text-left mt-8">
          ...
          <div className="col-span-1 bg-white/10 backdrop-blur-lg rounded-3xl p-6 border border-white/20">
            ...
            {isLocked ? (
              ...
              <Link href="/receipts?scan=true&returnTo=/" className="w-full bg-orange-500 text-white p-6 rounded-2xl text-xl font-bold shadow-lg hover:bg-orange-400 transition flex items-center gap-4">
                <svg className="w-10 h-10" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 9a2 2 0 012-2h.93a2 2 0 001.664-.89l.812-1.22A2 2 0 0110.07 4h3.86a2 2 0 011.664.89l.812 1.22A2 2 0 0018.07 7H19a2 2 0 012 2v9a2 2 0 01-2 2H5a2 2 0 01-2-2V9z" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 13a3 3 0 11-6 0 3 3 0 016 0z" /></svg>
                <span>Upload Receipt</span>
              </Link>
            )}
