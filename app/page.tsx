            ...
            <>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <Link href="/deals" className="bg-red-500 text-white p-5 rounded-2xl font-bold shadow-md hover:shadow-lg hover:-translate-y-0.5 transition flex flex-col items-center gap-2 text-center">
                  <span className="text-3xl">🔥</span>
                  <span className="leading-none">Local<br /><span className="text-xs opacity-75 font-normal">Deals</span></span>
                </Link>
              </div>
              ...
              <div className="grid grid-cols-3 gap-2 mt-2">
                ...
                <Link href="/stores" className="bg-white/20 backdrop-blur-md rounded-xl p-3 flex flex-col items-center justify-center text-white hover:bg-white/30 transition">
            ...
            <div className="mt-4 grid grid-cols-2 gap-2">
              {isLocked ? (
                <>
                  ...
                  <button onClick={handleLockedClick} className="bg-pink-500/80 hover:bg-pink-500 text-white py-2 rounded-lg text-sm font-semibold transition">Stores</button>
                </>
              ) : (
                <>
                  ...
                  <Link href="/stores" className="bg-pink-500/80 hover:bg-pink-500 text-white py-2 rounded-lg text-sm font-semibold transition text-center">Stores</Link>
                </>
              )}
            </div>
          </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-6 z-50 md:hidden">
          <div className="bg-white rounded-lg p-6 w-full max-w-xs">
            ...
            <div className="grid grid-cols-1 gap-3">
              <Link href="/trips" onClick={() => setShowMoreMenu(false)} className="w-full bg-lime-500 text-white px-10 py-3 rounded-lg text-base font-semibold hover:bg-lime-600 transition cursor-pointer text-center relative flex items-center">
