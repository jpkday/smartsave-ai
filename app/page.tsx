    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-500 to-green-400 flex items-center justify-center p-6">
      <div className="text-center text-white max-w-xs md:max-w-2xl w-full">
        ...
        <div className="grid grid-cols-1 gap-3 md:hidden">
          <Link href="/list" className="bg-yellow-500 text-white px-10 py-3 rounded-lg text-base font-semibold hover:bg-yellow-600 transition cursor-pointer text-center relative flex items-center">
            <span className="absolute left-4 text-xl">📝</span>
            <span className="flex-1 ml-6">Shopping List</span>
          </Link>
          
          <Link href="/compare" className="bg-green-500 text-white px-10 py-3 rounded-lg text-base font-semibold hover:bg-green-600 transition cursor-pointer text-center relative flex items-center">
            <span className="absolute left-4 text-xl">⚖️</span>
            <span className="flex-1 ml-6">Compare</span>
          </Link>
          
          <Link href="/history" className="bg-amber-700 text-white px-10 py-3 rounded-lg text-base font-semibold hover:bg-amber-800 transition cursor-pointer text-center relative flex items-center">
            <span className="absolute left-4 text-xl">📊</span>
          ...
          <button 
            ...
            className="bg-gray-700 text-white px-10 py-3 rounded-lg text-base font-semibold hover:bg-gray-800 transition cursor-pointer text-center relative flex items-center"
          >
            <span className="absolute left-4 text-xl">⋯</span>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-6 z-50 md:hidden">
          <div className="bg-white rounded-lg p-6 w-full max-w-xs">
            ...
            <div className="grid grid-cols-1 gap-3">
              <Link href="/items" onClick={() => setShowMoreMenu(false)} className="bg-purple-500 text-white px-10 py-3 rounded-lg text-base font-semibold hover:bg-purple-600 transition cursor-pointer text-center relative flex items-center">
                <span className="absolute left-4 text-xl">📋</span>
                <span className="flex-1 ml-6">Items</span>
              </Link>
              
              <Link href="/prices" onClick={() => setShowMoreMenu(false)} className="bg-blue-600 text-white px-10 py-3 rounded-lg text-base font-semibold hover:bg-blue-700 transition cursor-pointer text-center relative flex items-center">
                <span className="absolute left-4 text-xl">💰</span>
                <span className="flex-1 ml-6">Prices</span>
              </Link>
              
              <Link href="/receipts" onClick={() => setShowMoreMenu(false)} className="bg-orange-500 text-white px-10 py-3 rounded-lg text-base font-semibold hover:bg-orange-600 transition cursor-pointer text-center relative flex items-center">
                <span className="absolute left-4 text-xl">🧾</span>
                <span className="flex-1 ml-6">Receipts</span>
              </Link>
              
              <Link href="/stores" onClick={() => setShowMoreMenu(false)} className="bg-pink-500 text-white px-10 py-3 rounded-lg text-base font-semibold hover:bg-pink-600 transition cursor-pointer text-center relative flex items-center">
                <span className="absolute left-4 text-xl">🛍️</span>
                <span className="flex-1 ml-6">Stores</span>
              </Link>
            </div>
