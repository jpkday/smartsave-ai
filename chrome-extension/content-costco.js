// Content script for Costco pages
// This runs automatically on Costco order pages
...
(function() {
    ...
    badge.title = 'Click to sync this order to SmartSave';
    ...
    console.log('[SmartSave] Extension loaded on Costco page');
})();
